...
let sessionId = null; /!*urlParams.get('sessionId');*!/ // Unique identifier for the payment session
let redirectResult = null; /!*urlParams.get('redirectResult');*!/
let localclientKey = null;
  ...
  methods: {
    async startCheckout() {
      ...
      try {
        ...
        const checkoutSessionResponse = response;
        this.sessionId = checkoutSessionResponse.id;
        localStorage.setItem('sessionID', this.sessionId);
        this.redirectResult = checkoutSessionResponse.redirectResult;
